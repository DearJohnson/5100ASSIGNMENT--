...
public class LyricAnalyzer {
   ...
   public static void main(String[] args) throws IOException {
	...
	String path = "C:\\Program Files (x86)\\NetBeansProjects\\Assignment8\\src\\assignment8\\Question2_test1.txt";
	File testFile = new File(path);
	la.read(testFile);
	la.displayWords();
	System.out.println("Unique words count: " + la.count());
	System.out.println("Most frequently word: " + la.mostFrequentWord());
	path = "C:\\Program Files (x86)\\NetBeansProjects\\Assignment8\\src\\assignment8\\Question2_output1.txt";
